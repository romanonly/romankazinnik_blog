...
fname = '~/PycharmProjects/tests/webppl/Results2/data_banner.Rdata'
...
fname1 = "~/PycharmProjects/tests/webppl/models_banner_snaphot_R.Rdata"
save.image(fname1)
fname2 = "~/PycharmProjects/tests/webppl/models_banner_p1_p2.Rdata"
save(p_model_1, p_model_2, df_banner, file=fname2)
```
